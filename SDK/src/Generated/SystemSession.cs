...
namespace Harbard
{
	namespace Api
	{
		public class SystemSession : AApiSession
		{
			...
			{
				ApiResult ApiRes = session.executeCommand("System", "GetLocationSettings");
				var response = new LocationSettings();
			...
			public void GetLocationSettingsAsync(Action<LocationSettings, ApiException?> callback)
			{
				session.executeCommandAsync("System", "GetLocationSettings", (ApiResult ApiRes) =>
				{
					var response = new LocationSettings();
			...
			public LocationSettings SetLocationSettings()
			{
				ApiResult ApiRes = session.executeCommand("System", "SetLocationSettings");
				var response = new LocationSettings();
			...
			public void SetLocationSettingsAsync(Action<LocationSettings, ApiException?> callback)
			{
				session.executeCommandAsync("System", "SetLocationSettings", (ApiResult ApiRes) =>
				{
					var response = new LocationSettings();
