...
namespace Harbard
{
	namespace Api
	{
		...
		public class AnprEngineConfiguration_Config : AJsonSerializable
		{
			...
			public string? _DirectionHint;
			public bool _Speed;
			public SpeedHint? _SpeedHint;
			public string? _TextFormat;
			...
			public override JObject? serialize()
			{
				...
				_anprEngineConfiguration_Config.Add(new JProperty("DirectionHint", _DirectionHint));


				_anprEngineConfiguration_Config.Add(new JProperty("Speed", _Speed));

				if(_SpeedHint != null)
				{ _anprEngineConfiguration_Config.Add(new JProperty("SpeedHint", _SpeedHint.serialize())); }


				_anprEngineConfiguration_Config.Add(new JProperty("TextFormat", _TextFormat));
			...
			public override bool deserialize(JObject data)
			{
				...
				var data_DirectionHint = data["DirectionHint"];
				if(data_DirectionHint != null)
				{ _DirectionHint = Convert.ToString(data_DirectionHint); }
				else
				{ success = false; }

				var data_Speed = data["Speed"];
				if(data_Speed != null)
				{ _Speed = Convert.ToBoolean(data_Speed); }
				else
				{ success = false; }

				_SpeedHint = new SpeedHint();
				var data_SpeedHint = (JObject?)data["SpeedHint"];
				if(data_SpeedHint != null)
				{ success = success && _SpeedHint.deserialize(data_SpeedHint); }

				var data_TextFormat = data["TextFormat"];
				if(data_TextFormat != null)
				{ _TextFormat = Convert.ToString(data_TextFormat); }
				else
				{ success = false; }
		...
		public class LocationSettings_Config : AJsonSerializable
		{
			...
			public override JObject? serialize()
			{
				JObject _locationSettings_Config = new JObject();

				if(_Manual != null)
				{ _locationSettings_Config.Add(new JProperty("Manual", _Manual.serialize())); }

				if(_Network != null)
				{ _locationSettings_Config.Add(new JProperty("Network", _Network.serialize())); }

				return _locationSettings_Config;
			}
			...
			public override bool deserialize(JObject data)
			{
				...
				_Manual = new Manual();
				var data_Manual = (JObject?)data["Manual"];
				if(data_Manual != null)
				{ success = success && _Manual.deserialize(data_Manual); }

				_Network = new Network();
				var data_Network = (JObject?)data["Network"];
				if(data_Network != null)
				{ success = success && _Network.deserialize(data_Network); }
		...
		public class DetectorConfigurationANPR : DetectorConfiguration
		{
			...
			public List<string>? _Direction;
			public bool _AllowEmptyText;
			...
			public override JObject? serialize()
			{
				...
				if(base_jobj != null)
				{
					...
					base_jobj.Add(new JProperty("FuzzySearch", _FuzzySearch));

					if(_Direction != null)
					{ base_jobj.Add("Direction",Serializers.serialize_Liststring(_Direction)); }

					base_jobj.Add(new JProperty("AllowEmptyText", _AllowEmptyText));
			...
			public override bool deserialize(JObject data)
			{
				...
				var data_Direction = (JObject?)data["Direction"];
				if(data_Direction != null)
				{ _Direction = Deserializers.deserialize_Liststring(data_Direction); }
				else
				{ success = false; }

				var data_AllowEmptyText = data["AllowEmptyText"];
				if(data_AllowEmptyText != null)
				{ _AllowEmptyText = Convert.ToBoolean(data_AllowEmptyText); }
				else
				{ success = false; }
		...
		public class Manual : AJsonSerializable
		{
			public Position? _Position;

			public override JObject? serialize()
			{
				JObject _manual = new JObject();

				if(_Position != null)
				{ _manual.Add(new JProperty("Position", _Position.serialize())); }
			...
			public override bool deserialize(JObject data)
			{
				...
				var data_Position = (JObject?)data["Position"];
				if(data_Position != null)
				{ success = success && _Position.deserialize(data_Position); }
		...
		public class Network : AJsonSerializable
		{
			public string? _Host;
			public int _Port;
			...
			public override JObject? serialize()
			{
				JObject _network = new JObject();


				_network.Add(new JProperty("Host", _Host));


				_network.Add(new JProperty("Port", _Port));


				_network.Add(new JProperty("Protocol", _Protocol));
			...
			public override bool deserialize(JObject data)
			{
				...
				var data_Host = data["Host"];
				if(data_Host != null)
				{ _Host = Convert.ToString(data_Host); }
				else
				{ success = false; }

				var data_Port = data["Port"];
				if(data_Port != null)
				{ _Port = Convert.ToInt32(data_Port); }
				else
				{ success = false; }

				var data_Protocol = data["Protocol"];
				if(data_Protocol != null)
				{ _Protocol = Convert.ToString(data_Protocol); }
				else
				{ success = false; }
		...
		public class Position : AJsonSerializable
		{
			...
			public override JObject? serialize()
			{
				JObject _position = new JObject();


				_position.Add(new JProperty("Latitude", _Latitude));


				_position.Add(new JProperty("Longitude", _Longitude));
		...
		public class SpeedHint : AJsonSerializable
		{
			public double _Height;

			public override JObject? serialize()
			{
				JObject _speedHint = new JObject();


				_speedHint.Add(new JProperty("Height", _Height));
			...
			public override bool deserialize(JObject data)
			{
				...
				if(data_Height != null)
				{ _Height = Convert.ToDouble(data_Height); }
				else
				{ success = false; }
